@extends('dashboardadmin.adminpage')
    ...
    <div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
                    <h2 class="title1">List All Payment</h2>
					<div class="table-responsive bs-example widget-shadow">
                    <a href="{!!url('/createpayment')!!}" type="sumit" class="btn btn-primary btn-flat btn-pri"><i class="fa fa-plus" aria-hidden="true"></i> Add payment</a>
